...
ASCII_TABLE = [
#            !        "        #        $        %        &        '
    0x00000, 0x1000c, 0x00204, 0x0aa3c, 0x0aabb, 0x0ee99, 0x0b361, 0x00200,
#   (        )        *        +        ,        -        .        /
...
#   X        Y        Z        [        \        ]        ^        _
    0x05500, 0x02500, 0x04433, 0x02212, 0x01100, 0x02221, 0x05000, 0x00030,
#   `        a        b        c        d        e        f        g
...
#   p        q        r        s        t        u        v        w
    0x082c1, 0x0a281, 0x08040, 0x0a0a1, 0x080e0, 0x02060, 0x04040, 0x02078,
#   x        y        z        {        |        }        ~
    0x05500, 0x0a2a0, 0x0c020, 0x0a212, 0x02200, 0x02a21, 0x00A85, 0x00000,
]
