...
def ibm437_visible_decode(b):
    return b.decode('ibm437').translate({
        0x01: "\u263A", 0x02: "\u263B", 0x03: "\u2665", 0x04: "\u2666",
        0x05: "\u2663", 0x06: "\u2660", 0x07: "\u2022", 0x08: "\u25D8",
        0x09: "\u25CB", 0x0a: "\u25D9", 0x0b: "\u2642", 0x0c: "\u2640",
        0x0d: "\u266A", 0x0e: "\u266B", 0x0f: "\u263C", 0x10: "\u25BA",
...
# codecs.register_error('fallback_latin1', decode_fallback_latin1)
def decode_fallback_latin1(e):
    return e.object[e.start:e.end].decode('latin-1'), e.end

# codecs.register_error('fallback_cp1252', decode_fallback_cp1252)
def decode_fallback_cp1252(e):
